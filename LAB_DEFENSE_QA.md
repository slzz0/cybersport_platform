...
Native query - это SQL-запрос, специфичный для конкретной БД, используемый для сложных запросов или оптимизации производительности, но теряющий переносимость
